...
class About extends React.Component {
    ...
    async componentDidMount() {
        try {
            const response = await fetch("https://api.github.com/users/aryamansrivastava");
            ...
            <div className="about">
                    ...
                    <div className="about-me-body">
                        ...
                        <div className="about-me-details">
                            ...
                            <div className="about-me-links">
                                <Link
                                    to={"https://github.com/aryamansrivastava"}
                                    target="_blank"
                                    className="btn"
                                >
                                    <Github size={"1rem"} />
                                ...
                                <Link
                                    to={"https://github.com/aryamansrivastava/Food-Frenzy"}
                                    target="_blank"
                                    className="btn"
                                >
                                    <Code2Icon size={"1rem"} />
                ...
                <div className="about-project">
                    ...
                    <div className="about-project-text">
                        <span>
                            Food Frenzy is a food-ordering website that is built on top of the Swiggy
                            API, a well-renowned food ordering platform. By seamlessly integrating
                            technology with culinary expertise, Food Frenzy aims to provide users
                        ...
                        <span>
                            ...
                            traditional comfort food or exotic international flavors, Food Frenzy has
